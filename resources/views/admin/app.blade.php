...
<div class="wrapper">
    <div class="sidebar">
        ...
        <ul class='nav-items'> 
            ...
            <a href="#"><li><i class="fas fa-user"></i>لائحة الموظفين</li></a>
            <a href="#"><li><i class="fas fa-address-card"></i>المشاريع</li></a>
            <a href="#"><li><i class="fas fa-project-diagram"></i>portfolio</li></a>
